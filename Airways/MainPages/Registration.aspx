...
<body style="background-image: url('/Images/Main BGI.jpg'); background-size: cover;">
    ...
    <form id="EntryMaster" runat="server">
        ...
        <table class="table" style="background: rgba(255,255,255,0.6); height: 500px; width: 1335px; padding-left: 450px; border: ridge; border-radius: 8px;">
            <tr>
