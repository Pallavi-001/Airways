...
div.transbox p {
    ...
    <h1 style="text-align:center;margin-right:300px">Booking History</h1>
  ...
  <div class="transbox">
        ...
        <columns>
           ...
           <%--  <asp:BoundField DataField="Airline_Name" HeaderText="Airline Name" SortExpression="AirlineName" />--%>
